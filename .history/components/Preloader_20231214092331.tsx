...
/**the preloader of my home page of my next js app is supposed to show 2 different text at two different moments, hello when the user first lands on the page and thanks every time the user navigates the website and still comes to the home page without refreshing the page. how can i achieve this making sure that both text cant be shown at the same time */