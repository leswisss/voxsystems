  ...
  return (
    <section className="contact__hero">
      ...
      <div className="ccontact__header">
        ...
        <div className="cc__overflow">
          <p> Si vous avez des questions ou souhaitez discuter de votre projet avec nous, n’hésitez pas à nous contacter. Nous sommes là pour vous aider et nous serons heureux de répondre à toutes vos demandes.</p>
        </div>
      </div>
    </section>
  )
