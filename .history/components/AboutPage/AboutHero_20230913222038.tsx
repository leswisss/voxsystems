...
const AboutHero = ({setState, state, state2}: {setState: React.Dispatch<React.SetStateAction<boolean>>, state: boolean,  state2: boolean}) => {
  ...
  useEffect(() => {
    ...
    tl
      .to(background.current, {objectPosition: "0% 50%"})
    ...
    tl2
      ...
      .to(textRef[3].current, { y: "0%", duration: 1, ease: "power4" }, 0.1)
  ...
  return (
    <section className="about__hero">
      <div className="ahero__image" >
        <Image src={BACK} fill alt="Background Image" quality={100} placeholder="blur" sizes="100vw" ref={background} onLoadingComplete={() => setState(false)}/>
      </div>
