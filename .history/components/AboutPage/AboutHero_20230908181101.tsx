    ...
    <section className="about__hero">
      ...
      <div className="ahero__header">
        <div className="ahero__overflow">
          <h3 ref={text}>L'INNOVATION</h3>
        </div>
        <div className="ahero__overflow">
          <h3 ref={text}>CAMEROUNAISE POUR UN MONDE</h3>
        </div>
        <div className="ahero__overflow">
          <h3 ref={text}>MEILLEUR</h3>
        </div>
        <div className="ahero__overflow">
          <h3 ref={text}>L'INNOVATION CAMEROUNAISE POUR UN MONDE MEILLEUR</h3>
        </div>
      </div>
    </section>
  )
