    ...
    <section className="vision">
      <div className="container vision__container">
        <div className="vision__image">
          ...
          {active === 0 && (
            <motion.div variants={imageScaleAnim} initial="initial" exit="exit" animate="entry" className="vv-image">
              <Image
          ...
          {active === 1 && (
            <motion.div  variants={imageScaleAnim} initial="initial" exit="exit" animate="animate" className="vv-image">
            <Image
