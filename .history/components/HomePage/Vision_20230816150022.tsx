...
const Vision = () => {
  ...
  useEffect(() => {
    ...
    const updateBackground = () => {
      element && element.style.background = `conic-gradient(hsla(227, 77%, 57%, 0.4) ${degree}deg, rgba(255,255,255,0) 0deg)`;
    };

    const timeline = gsap.timeline({ repeat: -1 });
    timeline.to({}, { duration: 10, onUpdate: () => {
      degree += 17.64;
      updateBackground();
    }});
    timeline.to({}, { duration: 10, onUpdate: () => {
    ...
    <section className="vision">
      <div className="container vision__container">
        ...
        <div className="vision__content">
          <div className="circle__loader" ref={el}>
