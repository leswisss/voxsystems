      ...
      <div className="container ourteam__container">
        ...
        <div className="team__bottom">
          ...
          <div className="t-bottom__content">
            {
              TeamData.map((data, i) => (
                <TeamContent data={data} activeTeam={activeTeam} setActiveTeam={setActiveTeam} />
              ))
            }
            <>
              <motion.div variants={scaleAnimation} initial="initial" animate={activeTeam.active ? "entry" : "exit"} className="modal__container" ref={modalRef}>
                <div className="modal__slider" style={{ transform: `translateY(${-activeTeam.index*100}%)`}}>
                  {
                    TeamData.map((item) => {
              ...
              <motion.div variants={scaleAnimation} initial="initial" animate={activeTeam ? "entry" : "exit"} className="cursor" ref={cursorRef}>
