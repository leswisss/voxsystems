...
const TeamModal = ({team , activeModal}: ModalProps) => {
  ...
  useEffect(() => {
    ...
    const moveCursorX = gsap.quickTo(cursorRef.current, "left", {duration: 0.8, ease: "power3"})
    const moveCursorY = gsap.quickTo(cursorRef.current, "bottom", {duration: 0.8, ease: "power3"})
