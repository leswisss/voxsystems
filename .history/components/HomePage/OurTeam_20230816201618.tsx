...
const OurTeam = () => {
  ...
  useEffect( () => {
    //Move Container
    xMoveContainer.current = gsap.quickTo(modal.current, "left", {duration: 0.8, ease: "power3"})
    yMoveContainer.current = gsap.quickTo(modar.current, "top", {duration: 0.8, ease: "power3"})
    //Move cursor
