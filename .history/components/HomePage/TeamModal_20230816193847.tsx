...
const TeamModal = ({team , activeModal}: ModalProps) => {
  ...
  useEffect(() => {
    ...
    moveCursorX.current = gsap.quickTo(cursorRef.current, "left", {duration: 0.5, ease: "power3"})
    moveCursorY.current = gsap.quickTo(cursorRef.current, "top", {duration: 0.5, ease: "power3"})
