...
const OurTeam = () => {
  ...
  let xMoveContainer = 0;
  let yMoveContainer = 0;
  let xMoveCursor = 0;
  let yMoveCursor = 0;
  ...
  useEffect( () => {
    //Move Container
    xMoveContainer = gsap.quickTo(modalRef.current, "left", {duration: 0.8, ease: "power3"})
    yMoveContainer = gsap.quickTo(modalRef.current, "top", {duration: 0.8, ease: "power3"})
    //Move cursor
    xMoveCursor = gsap.quickTo(cursorRef.current, "left", {duration: 0.5, ease: "power3"})
    yMoveCursor = gsap.quickTo(cursorRef.current, "top", {duration: 0.5, ease: "power3"})
  }, [])
