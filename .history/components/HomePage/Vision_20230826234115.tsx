    ...
    <section className="vision">
      <div className="container vision__container">
        <div className="vision__image">
          ...
          {active === 0 && (
            <motion.div variants={imageScaleAnim} exit="exit" initial="initial" animate={active === 0 ? "entry" : "initial"}className="vv-image">
              <Image
          ...
          <AnimatePresence mode="wait">
          {active === 1 && (
            <motion.div  variants={imageScaleAnim} exit="exit" initial="initial"  animate={active === 1 ? "entry" : "initial"} className="vv-image">
            <Image
