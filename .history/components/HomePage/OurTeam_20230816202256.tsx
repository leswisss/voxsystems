...
const OurTeam = () => {
  ...
  const [xMoveContainer, setxMoveContainer] = useState(0)
  const [yMoveContainer, setyMoveContainer] = useState(0)
  const [xMoveCursor, setxMoveCursor] = useState(0)
  const [yMoveCursor, setyMoveCursor] = useState(0)
  ...
  useEffect( () => {
    //Move Container
    setxMoveContainer(gsap.quickTo(modalRef.current, "left", {duration: 0.8, ease: "power3"}))
