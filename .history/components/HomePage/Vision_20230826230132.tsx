    ...
    <section className="vision">
      <div className="container vision__container">
        <div className="vision__image">
          <Image src={VisionData[active].image} alt="Notre Vision" fill={true} key={`i${i}`} style={{opacity: active === i ? 1 : 0}} sizes="(max-width: 600px) 100%, 100%"/>

          <Image src={item.image} alt="Notre Vision" fill={true} key={`i${i}`} style={{opacity: active === i ? 1 : 0}} sizes="(max-width: 600px) 100%, 100%"/>
        </div>
