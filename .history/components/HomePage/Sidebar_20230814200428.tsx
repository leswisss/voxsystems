  ...
  return (
    ...
    <motion.div className='sidebar' variants={sideBarAnim} initial="initial" animate="entry" exit="exit">
      <div className="sidebar__container">
        ...
        <div className="s-burger__menu" onClick={() => setActiveSide(false)}>
            <motion.span variants={topBurgerAnim} animate={activeSide? "entry" : "initial"} className='top-burger'></motion.span>
            <motion.span variants={bottomBurgerAnim} animate={activeSide? "entry" : "initial"} className='bottom-burger'></motion.span>
        </div>
      </div>
    </motion.div>
