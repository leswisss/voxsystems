...
const OurTeam = () => {
  ...
  useEffect (() => {
    ...
    xMoveContainer(client[0])
    yMoveContainer(client[1])

    xMoveCursor(client[0])
    yMoveCursor(client[1])
  }, [])
    ...
    <section className="ourteam">
      <div className="container ourteam__container">
        ...
        <div className="team__bottom">
          ...
          <div className="t-bottom__content" onMouseMove={(e) => {moveItems(e.clientX, e.clientY), setClient([e.clientX, e.clientY])}}>
            {
              TeamData.map((data, i) => (
