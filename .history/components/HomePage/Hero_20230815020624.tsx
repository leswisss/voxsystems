          ...
          HeroData.map((item, i) => (
            <div className={`hero__services h-service-${i}`}>
              <div className="h-button">
                <motion.span className="button__animate" variants={loadingVariants} initial="start" onHoverStart={() => controls.stop()}
      onHoverEnd={() => controls.start("start")} animate="start"></motion.span>
