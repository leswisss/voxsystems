...
const TeamModal = ({team , activeModal}: ModalProps) => {
  ...
  useEffect(() => {
    ...
    const moveCursorX = gsap.quickTo(cursorRefRef.current, "left", {duration: 0.8, ease: "power3"})
    const moveCursorY = gsap.quickTo(modalRef.current, "bottom", {duration: 0.8, ease: "power3"})
