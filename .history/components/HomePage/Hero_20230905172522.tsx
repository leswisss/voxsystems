...
const Hero = () => {
  ...
  return (
    <section className="hero">
      <div className="background__images" style={{backgroundImage: "url('images/background.jpg')"}}>
        <Image src={Background} fill alt="Background Image" quality={100} placeholder="blur" sizes="100vw"/>
      </div>
        ...
        {HeroData.map((item, i) => (
          <div className={`hero__services h-service-${i}`} key={`h-${i}`}>
            ...
            <div
              ...
              onClick={() => {
                activeService[1] === i ? setActiveService([false, -1]):setActiveService([true, i]);
              }}
            >
              <motion.span
