...
const Hero = () => {
  ...
  locomoti.on('call', (value, way, obj) => {
    if (value === 'team-in-view') {
      // Update the data-scroll-speed attribute of the .team__overflow element
      const teamOverflow = document.querySelector('.team__overflow');
      teamOverflow.setAttribute('data-scroll-speed', '0.2');
    }
  });
