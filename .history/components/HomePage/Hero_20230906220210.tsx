  ...
  return (
    <section className="hero">
      ...
      <div className="container hero__container">
        ...
        <motion.div data-scroll data-scroll-speed="0.4" variants={OpacityAnim} initial="initial" animate="entry" className="scroll__container">
        ...
        {HeroData.map((item, i) => (
          <div data-scroll data-scroll-speed="0.4" className={`hero__services h-service-${i}`} key={`h-${i}`}>
            <div
