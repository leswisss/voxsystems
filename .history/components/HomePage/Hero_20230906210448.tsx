...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    tl2
      .from(textRef[0].current, {y: "100%"})
      .from(textRef[1].current, {y: "100%"}, 0)
      .from(textRef[2].current, {y: "100%"}, 0)
      .from(footerRef.current, {y: "200px"}, 0)
      ...
      <div className="container hero__container">
        <div className="hero__slogan">
          <div className="hero__overflow">
            <div  className="slogan__1" ref={textRef}>
              <span className="perpetua">24/7</span>
              <span className="h-slogan">UN</span>
            </div>
          </div>
          <div className="hero__overflow">
            <div className="slogan__2" ref={textRef}>SYSTÈMÈ</div>
          </div>
          <div className="hero__overflow">
            <div className="slogan__3" ref={textRef}>À LA FOIS</div>
          </div>
        </div>
