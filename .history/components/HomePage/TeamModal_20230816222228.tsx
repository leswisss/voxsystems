...
const TeamModal = ({team , activeModal}: ModalProps) => {
  ...
  const modalRef = useRef<HTMLDi(null)
  const cursorRef = useRef<HTMLDi(null)
  ...
  useEffect(() => {
    ...
    window.addEventListener("mousemove", (e) => {
      xMoveContainer(e.clientX - modalRef.current.off)
      yMoveContainer(e.clientY - 160)

      xMoveCursor(e.clientX - 125)
      yMoveCursor(e.clientY - 160)
    })
  }, [])
