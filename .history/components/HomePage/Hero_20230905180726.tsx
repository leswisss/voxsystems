...
import { HomeHeroSlogan } from "@/animations";
      ...
      <div className="container hero__container">
        <div className="hero__slogan">
          <div className="hero__overflow">
            <motion.div variants={SlideFromBottom} initial="initial" animate="entry" className="slogan__1">
              <span className="perpetua">24/7</span>
              <span className="h-slogan">UN</span>
            </motion.div>
          </div>
          <div className="hero__overflow">
            <motion.div variants={SlideFromBottom} initial="initial" animate="entry" className="slogan__2">SYSTÈMÈ</motion.div>
          </div>
          <div className="hero__overflow">
            <motion.div variants={SlideFromBottom} initial="initial" animate="entry" className="slogan__3">À LA FOIS</motion.div>
          </div>
        </div>
