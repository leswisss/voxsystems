...
const SolarHero = () => {
  ...
  useEffect(() => {
    ...
    tl2
      ...
      .to(heroRefs[4].current, {y: "0%", duration: 1, ease: "power4"}, 0.5)
      .to(heroRefs[5].current, {y: "0%", duration: 1, ease: "power4"}, 1)
      .to(heroRefs[6].current, {opacity: 1, duration: 1, ease: "power4"}, 1.5)
