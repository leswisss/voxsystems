      ...
      <div className="container solar-hero__container">
        <div className="s-hero__text">
          ...
          <div className="sh__desc">
            <div className="sh__overflow"><p ref={heroRefs[2]}>Nous transformons l'accès à l'énergie renouvelable avec des</p></div>
            <div className="sh__overflow"><p ref={heroRefs[2]}>solutions simples et puissantes.</p></div> 
