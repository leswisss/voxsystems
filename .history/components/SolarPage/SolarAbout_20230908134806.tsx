      ...
      <div className="container sa__container">
        <div className="sa__top">
          <div className="sa-top__left">
            ...
            <div className="sa__overflow">
              <p ref={textRefs[0]}>UNE LARGE GAMMES DE SERVICES</p>
            </div>
            <div className="sa__overflow">
              <p ref={textRefs[0]}>D'ÉNERGIE SOLAIRE, Y COMPRIS</p>
            </div>
            <div className="sa__overflow">
              <p ref={textRefs[0]}><span>L'INSTALLATION</span>, LA <span>MAINTENANCE</span> ET</p>
            </div>
            <div className="sa__overflow">
              <p ref={textRefs[0]}>LA <span>RÉPARATION</span> DE PANNAUX SOLAIRES</p>
            </div>
            <div className="sa__over-mobile">
            <p ref={textRefs[0]}>NOUS SOMMES FIERS DE PROPOSER UNE LARGE GAMMES DE SERVICES D'ÉNERGIE SOLAIRE, Y COMPRIS <span>L'INSTALLATION</span>, LA <span>MAINTENANCE</span> ET LA <span>RÉPARATION</span> DE PANNAUX SOLAIRES</p>
            </div>
          </div>
