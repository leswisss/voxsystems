    ...
    <section className="solar">
      <div className="container solar-hero__container">
        ...
        <div className="s-hero__image" ref={heroRefs[7]}>
              ...
              <Image src={heroImages[0]} alt="Solar Energy" onLoadingComplete={() => setState(false)} fill={true} sizes='(max-width: 600px) 100%, 100%' style={{opacity: activeImage === 0 ? 1 : 0}} />
              <Image src={heroImages[1]} alt="Solar Energy" onLoadingComplete={() => setState(false)} fill={true} sizes='(max-width: 600px) 100%, 100%' style={{opacity: activeImage === 1 ? 1 : 0}} />
        </div>
      </div>
    </section>
  )
