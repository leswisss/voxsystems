...
const SolarHero = () => {
  ...
  useEffect(() => {
    ...
    tl2
      ...
      .to(heroRefs[3].current, {y: "0%", duration: 1, ease: "power4"}, 0.2)
      .to(heroRefs[4].current, {y: "0%", duration: 1, ease: "power4"}, 0.3)
      .to(heroRefs[5].current, {y: "0%", duration: 1, ease: "power4"}, 0.2)
      .to(heroRefs[6].current, {opacity: 1, duration: 1, ease: "power4"}, 0.4)
      .to(heroRefs[7].current, {y: "0%", duration: 1, ease: "power4"}, 0.5)
  }, [])
  ...
  return (
    <section className="solar">
      <div className="container solar-hero__container">
        ...
        <div className="s-hero__image" data-scroll data-scroll-speed  ref={heroRefs[7]}>
          {
