...
interface AccordionProps{
  ...
  state: ActiveAccordionProps,
  setState: React.Dispatch<React.SetStateAction<ActiveAccordionProps>>
}

const SolarAccordion = ({data, state, setState}: AccordionProps) => {

  return (
    <div className="accordion__wrapper">
      <div className="accordion__header" onCl>
