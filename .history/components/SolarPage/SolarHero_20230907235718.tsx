      ...
      <div className="container solar-hero__container">
        <div className="s-hero__text">
          <div className="s-hero__header">
            <div className="sh__overflow"><p ref={heroRefs[]}>Investissez dans le <span>solaire</span></p></div>
            <div className="sh__overflow"><p ref={heroRefs[]}>pour un avenir radieux</p></div>
            <div className="sh__over-mobile"><p ref={heroRefs[]}>Investissez dans le <span>solaire</span> pour un avenir radieux</p></div>
          </div>
          <div className="sh__desc">
            ...
            <div className="sh__over-mobile"><p>Nous transformons l'accès à l'énergie renouvelable avec des solutions simples et puissantes.</p></div>
          </div>
