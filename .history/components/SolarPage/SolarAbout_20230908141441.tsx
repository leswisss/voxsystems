...
const SolarAbout = () => {
  ...
  const textRefs = [0, 1, 2, 3, 4, 5, 6].map(() => useRef(null));
    ...
    textRefs.forEach((textRef, i) => {
      gsap.from(textRef.current, {
        scrollTrigger: {
          ...
          start: i !==6 ?"top+=20px bottom": "top+=10px bottom",
          end: i !==6 ?"bottom+=50px bottom": "bottom+=40px bottom",
          scrub: true,
        },
      ...
      <div className="container sa__container">
        <div className="sa__top">
          <div className="sa-top__left">
            ...
            <div className="sa__overflow">
              <p ref={textRefs[3]}>
                <span>L'INSTALLATION</span>, LA <span>MAINTENANCE</span> ET
              </p>
            </div>
            <div className="sa__overflow">
              <p ref={textRefs[4]}>
                LA <span>RÉPARATION</span> DE PANNAUX SOLAIRES
              </p>
            </div>
            <div className="sa__over-mobile">
              <p ref={textRefs[5]}>
                NOUS SOMMES FIERS DE PROPOSER UNE LARGE GAMMES DE SERVICES
                D'ÉNERGIE SOLAIRE, Y COMPRIS <span>L'INSTALLATION</span>, LA{" "}
                <span>MAINTENANCE</span> ET LA <span>RÉPARATION</span> DE
                PANNAUX SOLAIRES
              </p>
            </div>
          </div>
