...
const SolarAccordion = ({data, state, setState, current}: AccordionProps) => {
  ...
  return (
    <div className="accordion__wrapper">
      ...
      <div className={`accordion__content ${current===state ? "active-accordion" : ""}`}>
        <div className="ac__container">
          ...
          <div className="ac__text">
            ...
            <Link href="/">CONTACTEZ NOUS <Icon icon={arrowUpBroken} style={{transform: current===state ? "active-accordion" : ""}}/></Link>
          </div>
        </div>
      </div>
    </div>
