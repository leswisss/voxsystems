        ...
        <div className="sa__top">
          <div className="sa-top__left">
            <div className="sa__overflow">
              <p ref={textR}>NOUS SOMMES FIERS DE PROPOSER</p>
            </div>
            <div className="sa__overflow">
              <p ref={textR}>UNE LARGE GAMMES DE SERVICES</p>
            </div>
            <div className="sa__overflow">
              <p ref={textR}>D'ÉNERGIE SOLAIRE, Y COMPRIS</p>
            </div>
            <div className="sa__overflow">
              <p ref={textR}><span>L'INSTALLATION</span>, LA <span>MAINTENANCE</span> ET</p>
            </div>
            <div className="sa__overflow">
              <p ref={textR}>LA <span>RÉPARATION</span> DE PANNAUX SOLAIRES</p>
            </div>
            <div className="sa__over-mobile">
            <p ref={textR}>NOUS SOMMES FIERS DE PROPOSER UNE LARGE GAMMES DE SERVICES D'ÉNERGIE SOLAIRE, Y COMPRIS <span>L'INSTALLATION</span>, LA <span>MAINTENANCE</span> ET LA <span>RÉPARATION</span> DE PANNAUX SOLAIRES</p>
            </div>
          </div>
