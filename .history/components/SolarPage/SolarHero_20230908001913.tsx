...
const SolarHero = () => {
  ...
  useEffect(() => {
    ...
    tl2
      ...
      .to(heroRefs[1].current, {y: "0%", duration: 1, ease: "power4"},)
      .to(heroRefs[2].current, {y: "0%", duration: 1, ease: "power4"})
      .to(heroRefs[3].current, {y: "0%", duration: 1, ease: "power4"})
      .to(heroRefs[4].current, {y: "0%", duration: 1, ease: "power4"})
  }, [])
