      ...
      <div className="container sa__container">
        <div className="sa__top">
          <div className="sa-top__left">
            ...
            <p>NOUS SOMMES FIERS DE PROPOSER UNE LARGE GAMMES DE SERVICES D'ÉNERGIE SOLAIRE, Y COMPRIS <span>L'INSTALLATION</span>, LA <span>MAINTENANCE</span> ET <p>LA <span>RÉPARATION</span> DE PANNAUX SOLAIRES</p></p>
            </div>
          </div>
