      ...
      <div className="container solar-hero__container">
        <div className="s-hero__text">
          <div className="s-hero__header">
            <div className="sh__overflow"><p ref={}>Investissez dans le <span>solaire</span></p></div>
            <div className="sh__overflow"><p ref={}>pour un avenir radieux</p></div>
            <div className="sh__over-mobile"><p ref={}>Investissez dans le <span>solaire</span> pour un avenir radieux</p></div>
          </div>
