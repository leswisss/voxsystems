...
const ServicesPage = () => {
  ...
  useEffect(() => {
    ...
    tl
      .to(textRefs[0].current, {y: "100%", duration: 1, ease: "power4"})
      .to(textRefs[1].current, {y: "100%", duration: 1, ease: "power4"})
      .to(textRefs[2].current, {y: "100%", duration: 1, ease: "power4"})
  }, [])
