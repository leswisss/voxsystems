    ...
    <section className="services__page">
      <div className="p-services__header">
        <div className="s-header__container">
          <div className="p__ser-overflow"><p className="ps__header" ref={text}>CE QUE</p></div>
          <div className="p__ser-overflow"><p className="ps__header" ref={text}>NOUS <span>OFFRONS</span></p></div>
          <div className="p__ser-overflow">
            <p className="ps__para" ref={text}>
