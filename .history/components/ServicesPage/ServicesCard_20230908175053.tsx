...
const ServicesCard = ({ data }: ServiceProps) => {
  ...
  return (
    <div className="p-services__card" data-scroll-section data-scroll-section-inview>
      ...
      <div className="card__content" >
        ...
        <Link className="p-contact" href={`/contacts?service=${data.slug}`} data-scroll data-scroll-speed="0.3" data-scroll-direction="horizontal">
          <span>
            CONTACTEZ <br />
            NOUS
          </span>
