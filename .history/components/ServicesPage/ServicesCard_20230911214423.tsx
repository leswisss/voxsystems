...
const ServicesCard = ({ data, setState}: ServiceProps) => {
  ...
  return (
    <div className="p-services__card">
      ...
      <div className="card__content" >
        ...
        <Link className="p-contact" href={`/contacts?service=${data.slug}`} data-scroll data-scroll-speed="0.2">
          <span>
            CONTACTEZ <br />
            NOUS
          </span>
