  ...
  return (
    <section className="vox__hero">
      ...
      <div className="container vox__hero-container">
        ...
        <div className="vox__hero-text" ref={textRef[5]} data-scroll data-scroll-speed="0.3">
          <p>
            Laissez-nous vous aider à simplifier votre routine quotidienne et à
            apporter de la facilité et commodité à votre vie.
          </p>
        </div>
        <motion.div data-scroll data-scroll-speed="0.3" variants={OpacityAnim} initial="initial" animate="entry" className="vox__explore">
          <span>
