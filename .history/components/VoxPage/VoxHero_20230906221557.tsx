...
const VoxHero = () => {
  ...
  return (
    <section className="vox__hero">
      ...
      <Image src={VOX} fill alt="Background Image" quality={100} placeholder="blur" sizes="100vw"/>
      <Image src={VOX2} fill alt="Background Image" quality={100} placeholder="blur" sizes="100vw"/>
