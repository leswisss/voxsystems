...
const VoxAbout = () => {
  const imageRefs = [0,1,2].map(() => useRef(null));
    ...
    imageRefs.forEach((imageRef, i) => {
      gsap.from(imageRef.current, {
        scrollTrigger: {
          ...
          start: "top+=230px bottom",
          end: "top+=330px bottom",
          scrub: 0.2,
          markers: true,
        },
      ...
      <div className="container vox__about-container">
        <div className="va-top">
          <div className="va__overflow">
            <div className="va-image" ref={imageRefs[0]}>
              <Image
                src={ABOUT}
          ...
          <div className="va__overflow">
            <div className="va-image" ref={imageRefs[1]}>
              <Image
                src={ABOUT2}
                alt="A propos de nous"
                fill={true}
        ...
        <div className="va-bottom">
          ...
          <div className="va__overflow">
            <div className="va-image" ref={imageRefs[2]}>
              <Image
                src={ABOUT3}
                alt="A propos de nous"
                fill={true}
