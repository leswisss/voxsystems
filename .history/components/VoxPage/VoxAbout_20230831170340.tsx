    ...
    <section className="vox__about">
      <div className="container vox__about-container">
        <div className="va-top">
          ...
          <div className="va__overflow">
            <div className="va-header"><span>QUI SOMMES</span> <span className="va-nous">NOUS?</span></div>
          </div>
          <div className="va__overflow">
            <div className="va-image"></div>
            <Image
              src={ABOUT2}
              alt="A propos de nous"
              fill={true}
        ...
        <div className="va-bottom">
          ...
          <div className="va__overflow">
            ...
            votre maison, y compris l'éclairage, le contrôle de la température,
            la sécurité et les divertissements. Chez Vox Link, nous croyons en
            l'innovation constante et en l'amélioration continue pour répondre
            aux besoins changeants de nos clients. Nous sommes fiers de notre
            engagement envers l'excellence et nous sommes impatients de vous
            aider à transformer votre maison en un havre de paix et de confort.
            </p>
          </div>
        </div>
      </div>
