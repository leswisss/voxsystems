    ...
    <section className="vox__hero">
      <div className="background__images">
        <Image
          ...
          placeholder="blur"
          sizes="100vw"
          style={{opacity: activeBack === 1 ? 1 : 0, transition: "all 0.7s linear"}}
        />
        <Image
          src={VOX3}
          fill
          ...
          placeholder="blur"
          sizes="100vw"
          style={{opacity: activeBack === 0 ? 1 : 0, transition: "all 0.7s linear"}}
        />
      </div>
      <div className="container vox__hero-container">
        <div className="vox__hero-slogan">
          <div className="vox__overflow">
            <span ref={textRef[0]}className="v-automatisez">AUTOMATISEZ</span>{" "}
            <span ref={textRef[1]}>VOTRE</span>
          </div>
          <div className="vox__overflow">
            <span ref={textRef[1]}>MAISON SIMPLIFIEZ</span>
          </div>
          <div className="vox__overflow">
            <span ref={textRef[1]}>VOTRE VIE</span>
          </div>
