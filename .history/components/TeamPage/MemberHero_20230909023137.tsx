...
const MemberHero = () => {
  ...
  useEffect(() => {
    ...
    tl2
      ...
      .to(textRef[2].current, {y: "0%", duration: 1, ease: "power4"}, )
      .to(textRef[3].current, {opacity: 1, duration: 2, ease: "power4"}, 0.5)
      .to(textRef[4].current, {opacity: 1, duration: 2, ease: "power4"}, 0.5)
  }, [])
      ...
      <div className="container member__container">
        <div className="member__wrapper">
          ...
          <div className="text__container">
            <span ref={textRef[3]}><Icon icon={upArrow}></Icon></span>
            <div className="member__overflow">
              <p ref={textRef[2]}>
