...
const MemberHero = () => {
  ...
  useEffect(() => {
    ...
    tl2
      ...
      .to(textRef[3].current, {opacity: 1, duration: 1, ease: "power4"}, 0.5)
      .to(textRef[4].current, {opacity: 1, duration: 1, ease: "power4"}, 0.5)
  }, [])
    ...
    <section className="member">
      <div className="container member__container">
        <div className="member__wrapper">
          ...
          <div className="name__container">
            <div className="member__overflow"><h4 ref={textRef}>Schneider</h4></div>
          </div>
