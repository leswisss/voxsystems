      ...
      <div className="container ttest__container">
        ...
        <div className="test__text">
          <div className="tt__content">
            ...
            <div className="test__overflow">
              <p ref={textRefs[0]}>“La meilleure partie de mon travail est de pouvoir dire</p>
            </div>
            <div className="test__overflow">
              <p ref={textRefs[0]}>aux clients: Vous adorerez travailler avec notre</p>
            </div>
            <div className="test__overflow">
              <p ref={textRefs[0]}>équipe, et de savoir que c'est la vérité.”</p>
            </div>
            <div className="test__overflow">
