...
const TeamContact = () => {
  ...
  useEffect(() => {
    ...
    tl
      ...
      .from(linkRefs[1].current, {opacity: 0, duration: 1, ease: "power4"})
      .from(linkRefs[2].current, {opacity: 0, duration: 1, ease: "power4"})
      .from(linkRefs[3].current, {opacity: 0, duration: 1, ease: "power4"})
  }, [])
