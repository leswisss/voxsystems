        ...
        <div className="test__text">
          <div className="tt__content">
            <div className="test__overflow">
              <p ref={}>“La meilleure partie de mon travail est de pouvoir dire aux clients: Vous adorerez travailler avec notre équipe, et de savoir que c'est la vérité.”</p>
            </div>
            <div className="test__overflow">
              <p ref={}>“La meilleure partie de mon travail est de pouvoir dire</p>
            </div>
            <div className="test__overflow">
              <p ref={}>aux clients: Vous adorerez travailler avec notre</p>
            </div>
            <div className="test__overflow">
              <p ref={}>équipe, et de savoir que c'est la vérité.”</p>
            </div>
            <div className="test__overflow">
