        ...
        <div className="footer__top">
          <div className="f-top__header">
            <div className="footer__overflow">
              <motion.div
                variants={slideYFooterAnim}
                animate={inView ? "entry" : "initial"}
                className="f-logo-wrap"
              >
                ...
                <div className="footer__links" key={`ff-${i}`}>
                  ...
                  <div className="f-links__container">
                    {item.links.map((link, i) => (
                      <motion.div
                        className="f-link-wrap"
                        key={`f-${i}`}
                        custom={i}
                        variants={slideLinkFooterAnim}
                        animate={inView ? "entry" : "initial"}
                      >
