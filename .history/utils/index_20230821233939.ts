...
export const AboutPageData = [
  ...
  },
  {
    ...
    normal: true,
    name: "NOTRE MISSION",
    text: "Notre mission chez System est de fournir des solutions innovantes et durables pour améliorer la vie quotidienne de nos clients. Nous nous engageons à offrir des produits et des services de qualité supérieure, adaptés aux besoins et aux préférences de chacun.",
  ...
  },
  {
    ...
    text: "System est plus qu'ne simple innovation, nous sommes une communauté active de plus de 1000 membres et en constante augmentation. Suivez-nous sur nos réseaux sociaux et découvrez le style de vie de SYSTEMS.",
