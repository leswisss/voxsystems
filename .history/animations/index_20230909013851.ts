...
export const teamContactAnim = {
  initial: (i: number) => ({height: 0, transition: { duration: 1, ease: [0.87, 0, 0.13, 1], delay: 0.5 * i}}),
  entry: (i: number) => ({height : "100%", transition: { duration: 1, ease: [0.87, 0, 0.13, 1], delay: 0.5 * i}})
}