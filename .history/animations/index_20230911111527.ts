...
export const preloaderTextAnim = {
  initial: (i: number) => ({y: "100%", transition: { duration: 0.2, ease: [0.61, 1, 0.88, 1], delay: 0.5 * i}}),
  entry: (i: number) => ({y: "0%", transition: { duration: 0.2, ease: [0.61, 1, 0.88, 1], delay: 0.5 * i}}),
  exit: (i: number) => ({y: "-100%", transition: { duration: 0.2, ease: [0.61, 1, 0.88, 1], delay: 0.5 * i}}),
}