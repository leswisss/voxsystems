...
export const preloaderTextAnim = {
  ...
  entry: (i: number) => ({y: "0%",  transition: { duration: 0.5, ease: [0.7, 0, 0.3, 1], delay: 0.03 * i}}),
  exit: (i: number) => ({y: "-100%",  transition: { duration: 0.5, ease: [0.7, 0, 0.3, 1], delay: 0.03 * i}}),
}

export const preloaderText2Anim = {
  initial: (i: number) => ({y: "100%"}),
  entry: (i: number) => ({y: "0%",  transition: { duration: 0.5, ease: [0.7, 0, 0.3, 1], delay: 1.5 + 0.03 * i}}),
  exit: (i: number) => ({y: "-100%",  transition: { duration: 0.5, ease: [0.7, 0, 0.3, 1], delay: 0.03 * i}}),
}

export const preloaderAnim = {
  initial: { y: "0%"},
  exit: {y: "-100%", transition: { duration: 0.2, ease: [0.7, 0, 0.3, 1]}}
}


export const preloaderHAnim = {
  initial: { opacity: 0, transition: { duration: 0.7, ease: [0.7, 0, 0.3, 1]}},
  exit: {opacity: 1, transition: { duration: 0.7, ease: [0.7, 0, 0.3, 1]}}
  entry: {opacity: 1, transition: { duration: 0.7, ease: [0.7, 0, 0.3, 1]}}
