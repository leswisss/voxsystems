...
export const teamContactAnim = {
  initial: (i: number) => ({opacity: "0", transition: { duration: 0.6, ease: [0.87, 0, 0.13, 1], delay: 0.1 * i}}),
  entry: (i: number) => ({opacity: 1, transition: { duration: 0.7, ease: [0.87, 0, 0.13, 1], delay: 0.1 * i}})
}