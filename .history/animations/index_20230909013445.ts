...
export const teamContactAnim = {
  initial: (i: number) => ({opacity: 0, transition: { duration: 0.5, ease: [0.87, 0, 0.13, 1], delay: 0.5 * i}}),
  entry: (i: number) => ({opacity: 1, transition: { duration: 0.5, ease: [0.87, 0, 0.13, 1], delay: 0.5 * i}})
}