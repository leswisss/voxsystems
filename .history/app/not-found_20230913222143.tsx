    ...
    <section className="not__found">
      <div className="container not__found-container">
        <div className="not-found__overflow">
          <h3 ref={textRef[]}>CETTE PAGE</h3>
        </div>
        <div className="not-found__overflow">
          <h3 ref={textRef[]}>N'EXISTE PAS</h3>
        </div>
        <div className="not__link-container">
          <Link ref={textRef[]} href="/"><span><Icon icon={arrowLeftThin} /></span>RETOUR À LA PAGE D'ACCEUIL</Link>
          <Link ref={textRef[]} href="/"><span><Icon icon={arrowLeftThin} /></span>RETOUR À LA PAGE PRÉCÉDENTE</Link>
        </div>
      </div>
    </section>
  )
