    ...
    <section className="not__found">
      <div className="container not__found-container">
        ...
        <div className="not__link-container">
          <Link href="/"><span><Icon icon={arrowLeftThin} /></span>RETOUR A LA PAGE D'ACCEUIL</Link>
          <Link href="/"><span><Icon icon={arrowLeftThin} /></span>RETOUR A LA PAGE PRECEÉÉDENTE</Link>
        </div>
