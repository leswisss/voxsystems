  ...
  return (
    <section className="not__found">
      <div className="container not__found-container">
        ...
        <div className="not-found__overflow">
          <h3 ref={textRef[0]}>N'EXISTE PAS</h3>
        </div>
        <div className="not__link-container">
          <Link ref={textRef[0]} href="/"><span><Icon icon={arrowLeftThin} /></span>RETOUR À LA PAGE D'ACCEUIL</Link>
          <Link ref={textRef[0]} href="/"><span><Icon icon={arrowLeftThin} /></span>RETOUR À LA PAGE PRÉCÉDENTE</Link>
        </div>
      </div>
    </section>
  )
