...
const NotFoundPage = () => {
  ...
  useEffect(() => {
    ...
    tl2
      ...
      .to(textRef[1].current, { y: "0%", duration: 1, ease: "power4" }, 0.0)
      .to(textRef[2].current, { x: "0%", duration: 1, ease: "power4" }, 1)
      .to(textRef[3].current, { x: "0%", duration: 1, ease: "power4" }, )
  }, [])
  return (
    <section className="not__found">
      <div className="container not__found-container">
        ...
        <div className="not__link-container">
          ...
          <Link ref={textRef[3]} href="/"><span><Icon icon={arrowLeftThin} /></span>RETOUR À LA PAGE PRÉCÉDENTE</Link>
        </div>
      </div>
    </section>
  )
