...
const poppins = Poppins({ subsets: ["latin"], weight: ["300", "400", "500"], variable: '--poppings-font' })
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${poppins.variable} ${monument.variable} ${monumentbold.variable} ${perpetua.variable}`}>
        <Navbar />
        {children}
        <Footer/>
      </body>
