...
const VoxHero = ({
  ...
  useEffect(() => {
    ...
    tl.to(backImage[0].current, { objectPosition: "0% 50%" }).to(
      backImage[1].current,
      { objectPosition: "0% 50%" },
      0
    );
    ...
    tl2
      ...
      .to(textRef[2].current, { y: "0%", duration: 1, ease: "power4" }, 0.1)
      .to(textRef[3].current, { y: "0%", duration: 1, ease: "power4" }, 0.1)
      .to(textRef[4].current, { x: "0%", duration: 1, ease: "power4" }, 0.1)
